...
#End Region
    ...
    Public Function GetRecords() As DataTable
        Try
            Return objDT("sp_Group_GetAll @CompanyCode=" & CompanyCode)
    ...
    Public Function DeleteRecords() As DataTable
        Try
            Return objDT("sp_Group_Delete @GroupCode=" & GroupCode & ",@CompanyCode=" & CompanyCode)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function BindRecords() As DataSet
        Try
            Return objDS("sp_Group_BindData @CompanyCode=" & CompanyCode)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
