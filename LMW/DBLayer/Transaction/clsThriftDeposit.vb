    ...
    Public Function SaveRecords()
        ...
        Try
            For Rowindex As Integer = 0 To ObjInput.Rows.Count - 1
                Dim objCommand As New SqlCommand("sp_ThriftDeposit_AddEdit", objConnection, objTrans)
                objCommand.CommandType = CommandType.StoredProcedure
                'If Val(Grid.Item("ThriftDepositCode", rowindex).Value) > 0 
                If Val(ObjInput.Rows.Item(Rowindex)("ThriftDepositCode")) > 0 Then
                    objCommand.Parameters.AddWithValue("@ThriftDepositCode", ObjInput.Rows.Item(Rowindex)("ThriftDepositCode"))
                End If
                objCommand.Parameters.AddWithValue("@ThriftDepositDate", ObjInput.Rows.Item(Rowindex)("ThriftDepositDate"))
