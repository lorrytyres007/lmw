...
Partial Class frmTDClossingDetails
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblTitle.Text = "TDClossing Details"
        '
        'Edit1
        '
