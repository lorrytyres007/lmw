...
Partial Class rptHeadList
    ...
    Private Sub InitializeComponent()
        ...
        ReportDataSource1.Name = "rptDataSet_sp_HeadList_GetAll"
        ReportDataSource1.Value = Nothing
        Me.rptViewer.LocalReport.DataSources.Add(ReportDataSource1)
        Me.rptViewer.LocalReport.ReportEmbeddedResource = "sTapes.rptHeadList.rdlc"
