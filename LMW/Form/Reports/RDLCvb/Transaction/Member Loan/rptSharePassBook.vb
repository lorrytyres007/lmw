...
Public Class rptSharePassBook

    Private Sub rptSharePassBook_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bind_Data()
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        If chkDate.Checked = True Then
            ...
            If CDate(dtpTo.Text) < CDate(dtpFrom.Text) Then
                ...
                Exit Sub
            End If
            Dim objDCom As New SqlCommand("delete from tbl_SHare_Passbook where membercode=" & cmbEmployeeNumber.ColData("MemberCode"), objSqlConnection)
            ...
            Dim objcommand As New SqlCommand("Update tbl_Share_PassBook set printed=0 where  MemberCode=" & cmbEmployeeNumber.ColData("MemberCode") & " and ShareDepositdate >='" & SD(dtpFrom.Value) & "' and ShareDepositdate <='" & SD(dtpTo.Value) & "'", objSqlConnection)
        ...
        PBar1.Value = 25
        Application.DoEvents()
        Dim objCom As New SqlCommand("sp_Update_SharePassBook", objSqlConnection)
        ...
        PBar1.Value = 60
        Application.DoEvents()
        Dim objCom1 As New SqlCommand("sp_SharePassBook_Linenumber_Page_Balance", objSqlConnection)
        ...
        objSqlCommand = New SqlCommand("sp_Share_PassBook", objSqlConnection)
        ...
        objRDS1.Name = "LMWDataSet_sp_Share_PassBook"
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptShare_PassBook.rdlc"
    ...
    Private Sub rptSharePassBook_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        If MsgBox("Is it Printed?... ", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, Mssg) = MsgBoxResult.Ok Then
            Dim SQLQuery As String = "Update tbl_Share_PassBook set printed=1 where "
            Initialise_Connection()
            If chkDate.Checked = True Then
                SQLQuery = SQLQuery + "  MemberCode=" & cmbEmployeeNumber.ColData("MemberCode") + " and ShareDepositDate >='" + SD(dtpFrom.Value) + "' and ShareDepositDate <='" + SD(dtpTo.Value) + "'"
            Else
