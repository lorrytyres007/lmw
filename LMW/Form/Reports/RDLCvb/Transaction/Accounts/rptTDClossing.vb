...
Public Class rptTDClossing
    Private Sub rptTDClossing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub BindData()
        cmbEmpNo.RecordSet(objDT("Select *,convert(varchar,EmployeeNumber) as strEmpno From tbl_Member where memberCode in (select MemberCode from tbl_TDClossing)"), "strEmpno", "MemberCode")
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        Dim objcommand As New SqlCommand("sp_TDClossing_GetAll", objSqlConnection)
        ...
        objRDS1.Name = "LMWDataSet_sp_TDClossing_GetAll"
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptTDClossing.rdlc"
    ...
    Private Sub rptTDClossing_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
