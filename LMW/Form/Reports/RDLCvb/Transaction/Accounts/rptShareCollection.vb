...
Public Class rptShareCollection
    Dim objTDCollection As New DBLayer.clsGledger
    Dim fystarting As DateTime
    Dim FYSTART As DateTime
    Dim FYEND As DateTime
    Private Sub rptShareCollection_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Bind_Data()
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        objSqlCommand = New SqlCommand("sp_ShareCollection_rpt", objSqlConnection)
        ...
        objRDS1.Name = "LMWDataSet_sp_ShareCollection_rpt"
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptShareCollection.rdlc"
    ...
    Private Sub rptShareCollection_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
