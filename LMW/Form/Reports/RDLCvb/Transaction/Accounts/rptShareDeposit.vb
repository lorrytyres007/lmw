...
Public Class rptShareDeposit
    Dim objShareDeposit As New DBLayer.clsGledger
    Dim fystarting As DateTime
    Dim FYSTART As DateTime
    Dim FYEND As DateTime
    Private Sub rptShareDeposit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Bind_Data()
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        objSqlCommand = New SqlCommand("sp_ShareDeposit", objSqlConnection)
        ...
        objRDS1.Name = "LMWDataSet_sp_ShareDeposit"
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptShareDeposit.rdlc"
    ...
    Private Sub rptShareDeposit_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
    ...
    Private Sub Bind_Data()
        Try
            ...
            objShareDeposit.CompanyCode = int_CompanyCode
            cmbEmpNo.RecordSet(objShareDeposit.BindRecords.Tables(2), "strEmpNo", "MemberCode")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
