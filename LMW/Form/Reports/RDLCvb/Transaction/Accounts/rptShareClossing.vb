...
Public Class rptShareClossing
    Private Sub rptShareClossing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub BindData()
        cmbEmpNo.RecordSet(objDT("Select *,convert(varchar,EmployeeNumber) as strEmpno From tbl_Member where memberCode in (select MemberCode from tbl_ShareClossing)"), "strEmpno", "MemberCode")
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        Dim objcommand As New SqlCommand("sp_ShareClossing_GetAll", objSqlConnection)
        ...
        objRDS1.Name = "LMWDataSet_sp_ShareClossing_GetAll"
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptShareClossing.rdlc"
    ...
    Private Sub rptShareClossing_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
