...
Public Class rptLedgerAbstract
    Dim objLedgerAbstract As New DBLayer.clsGledger

    Private Sub rptLedgerAbstract_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Bind_Data()
    End Sub
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        rptViewer.LocalReport.ReportEmbeddedResource = "LMW.rptLedgerAbstract.rdlc"
    ...
    Private Sub rptLedgerAbstract_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        FormShown(Me)
    End Sub
    ...
    Private Sub Bind_Data()
        Try
            ...
            objLedgerAbstract.CompanyCode = int_CompanyCode
            cmbGroupName.RecordSet(objLedgerAbstract.BindRecords.Tables(1), "Groupname", "Groupcode")
            cmbLedger.RecordSet(objLedgerAbstract.BindRecords.Tables(0), "HeadName", "HeadCode")
